...
const Template2 = (args, { argTypes }) => {
    return ({
        props: Object.keys(argTypes),
        components: { tButton },
        template: "<t-button dropdown='true' v-bind='$props'><template v-slot:icon><span>icon</span></template></tbutton>",
        methods: { clickAction: action('botão clicado') }
    })
};
...
ButtonSelect.args = {
    ...
    itemsSelect: [
        ...
        {
            icon: `<feather-icon icon='MoreVerticalIcon' size='16' class='d-color align-middle mr-25' />`,
            title: 'example2',
            click: null,
        },
    ]
